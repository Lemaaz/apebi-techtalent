...
export default async function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh">
      ...
      <div className="hidden flex-col justify-between bg-[#0F0F0F] px-10 py-10 lg:flex lg:w-[46%] xl:w-1/2">
        {/* Logo */}
        <Link href="/" className="inline-flex items-center gap-2">
          ...
          <span className="font-heading text-sm font-semibold text-white">
            APEBI <span style={{ color: '#00AFD2' }}>Tech</span>Talent
          </span>
        </Link>

        {/* Network SVG */}
        <div className="flex flex-1 items-center justify-center py-8" aria-hidden>
          <svg viewBox="0 0 360 300" xmlns="http://www.w3.org/2000/svg" className="h-[280px] w-[360px]">
            ...
            <circle cx="40" cy="160" r="10" fill="#00AFD2" opacity="0.65" />
            <circle cx="330" cy="155" r="10" fill="#00AFD2" opacity="0.65" />
            <circle cx="230" cy="270" r="10" fill="#00AFD2" opacity="0.60" />
            <circle cx="40" cy="270" r="8" fill="#00AFD2" opacity="0.55" />
            <circle cx="80" cy="80" r="26" fill="#0a1a26" />
            <circle cx="80" cy="80" r="26" fill="none" stroke="#00AFD2" strokeWidth="1" opacity="0.35" />
            <text x="80" y="84" textAnchor="middle" fill="#00AFD2" fontSize="8" fontWeight="600" fontFamily="Poppins, sans-serif">DEV</text>
            <circle cx="280" cy="85" r="26" fill="#0a1a26" />
            <circle cx="280" cy="85" r="26" fill="none" stroke="#00AFD2" strokeWidth="1" opacity="0.35" />
            <text x="280" y="89" textAnchor="middle" fill="#00AFD2" fontSize="8" fontWeight="600" fontFamily="Poppins, sans-serif">DATA</text>
            <circle cx="290" cy="210" r="26" fill="#0a1a26" />
            <circle cx="290" cy="210" r="26" fill="none" stroke="#00AFD2" strokeWidth="1" opacity="0.35" />
            <text x="290" y="214" textAnchor="middle" fill="#00AFD2" fontSize="8" fontWeight="600" fontFamily="Poppins, sans-serif">CYBER</text>
            <circle cx="80" cy="220" r="26" fill="#0a1a26" />
            <circle cx="80" cy="220" r="26" fill="none" stroke="#00AFD2" strokeWidth="1" opacity="0.35" />
            <text x="80" y="224" textAnchor="middle" fill="#00AFD2" fontSize="8" fontWeight="600" fontFamily="Poppins, sans-serif">CLOUD</text>
            <circle cx="180" cy="150" r="48" fill="#00AFD2" opacity="0.04" />
            <circle cx="180" cy="150" r="34" fill="#0a1f2e" />
            <circle cx="180" cy="150" r="34" fill="none" stroke="#00AFD2" strokeWidth="1.5" opacity="0.55" />
            <text x="180" y="146" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="7.5" fontFamily="Poppins, sans-serif">APEBI</text>
            <text x="180" y="158" textAnchor="middle" fill="#00AFD2" fontSize="8.5" fontWeight="700" fontFamily="Poppins, sans-serif">TechTalent</text>
          </svg>
        </div>
        ...
        <div>
          <p className="mb-6 font-heading text-xl font-bold leading-tight text-white">
            ...
            <span style={{ color: '#00AFD2' }}>l&apos;écosystème APEBI</span>
          </p>
          <dl className="grid grid-cols-3 gap-4">
            {DARK_STATS.map(({ value, label }) => (
              <div key={label}>
                <dt className="font-heading text-2xl font-bold" style={{ color: '#00AFD2' }}>{value}</dt>
